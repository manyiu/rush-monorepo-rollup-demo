import { styled as styled$1, useTheme, alpha, useThemeProps, createTheme } from '@mui/material/styles';
export { ThemeProvider } from '@mui/material/styles';
import require$$0, { useForkRef, useEventCallback, ownerDocument, createSvgIcon as createSvgIcon$1, useControlled, capitalize } from '@mui/material/utils';
import require$$2, { jsxs, jsx } from 'react/jsx-runtime';
import { styled, Accordion as Accordion$1, IconButton, Button, TextField as TextField$1, Paper as Paper$1, Autocomplete, Switch, MenuItem, Select } from '@mui/material';
import AccordionDetails from '@mui/material/AccordionDetails';
import AccordionSummary from '@mui/material/AccordionSummary';
import Typography from '@mui/material/Typography';
import * as React from 'react';
import React__default, { Children, isValidElement, cloneElement, useReducer, useRef, useLayoutEffect, useEffect, createElement } from 'react';
...
var StyledAccordion = styled(Accordion$1)(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  &.MuiAccordion-root {\n    border-radius: 15px;\n  }\n"], ["\n  &.MuiAccordion-root {\n    border-radius: 15px;\n  }\n"])));
var Accordion = function (_a) {
    ...
    return (React.createElement(StyledContainer$5, null,
        ...
        , { 
            ...
            React.createElement(AccordionSummary, { expandIcon: React.createElement(default_1$2, { fontSize: "large", sx: { color: "#2D9FC3" } }), "aria-controls": "panel1bh-content", id: "panel1bh-header" },
...
const PickersModalDialogRoot = styled$1(Dialog)({
...
const PickersModalDialogContent = styled$1(DialogContent)({
  '&:first-of-type': {
    padding: 0
  }
});
const PickersModalDialogActions = styled$1(DialogActions)(({
  ownerState
...
const PickersModalDialog = props => {
  ...
  return /*#__PURE__*/jsxs(PickersModalDialogRoot, _extends({
    ...
    children: [/*#__PURE__*/jsx(PickersModalDialogContent, {
      ...
      children: [clearable && /*#__PURE__*/jsx(Button$1, {
        onClick: onClear,
        children: clearText
      }), showTodayButton && /*#__PURE__*/jsx(Button$1, {
        onClick: onSetToday,
        children: todayText
...
const PickersPopperRoot = styled$1(Popper)(({
  theme
}) => ({
  zIndex: theme.zIndex.modal
}));
const PickersPopperPaper = styled$1(Paper)(({
  ownerState
}) => _extends({
...
const PickersPopperAction = styled$1(DialogActions)(({
  ownerState
      ...
      children: /*#__PURE__*/jsx(TransitionComponent, _extends({}, TransitionProps, {
        children: /*#__PURE__*/jsxs(PickersPopperPaper, _extends({
          ...
          children: [children, /*#__PURE__*/jsx(PickersPopperAction, {
            ownerState: ownerState,
            children: clearable && (_Button || (_Button = /*#__PURE__*/jsx(Button$1, {
              onClick: onClear,
              children: clearText
            })))
          })]
...
function ResponsiveTooltipWrapper(props) {
  ...
  return isDesktop ? /*#__PURE__*/jsx(DesktopTooltipWrapper, _extends({
    DateInputProps: DateInputProps,
    KeyboardDateInputComponent: KeyboardDateInputComponent,
    PopperProps: PopperProps,
    TransitionComponent: TransitionComponent
  }, other)) : /*#__PURE__*/jsx(MobileWrapper, _extends({
    cancelText: cancelText,
    clearable: clearable,
    clearText: clearText,
    DateInputProps: DateInputProps,
...
var PenIcon = createSvgIcon$1( /*#__PURE__*/jsx("path", {
  d: "M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34a.9959.9959 0 00-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"
}), 'Pen');

var CalendarIcon = createSvgIcon$1( /*#__PURE__*/jsx("path", {
  d: "M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z"
}), 'Calendar');

var ClockIcon = createSvgIcon$1( /*#__PURE__*/jsxs(React.Fragment, {
...
const PickersToolbarGrid = styled$1(Grid)({
  flex: 1
});
...
const DateRangePickerToolbarRoot = styled$1(PickersToolbar$1)({
  [`& .${classes$5.penIcon}`]: {
    position: 'relative',
    top: 4
  }
...
const DateRangePickerToolbar = ({
  ...
  return /*#__PURE__*/jsx(DateRangePickerToolbarRoot, {
    toolbarTitle: toolbarTitle,
    isMobileKeyboardViewOpen: isMobileKeyboardViewOpen,
    toggleMobileKeyboardView: toggleMobileKeyboardView,
    isLandscape: false,
    penIconClassName: classes$5.penIcon,
    children: /*#__PURE__*/jsxs(DateRangePickerToolbarContainer, {
      children: [/*#__PURE__*/jsx(PickersToolbarButton$1, {
        variant: start !== null ? 'h5' : 'h6',
        value: startDateValue,
        selected: currentlySelectingRangeEnd === 'start',
        onClick: () => setCurrentlySelectingRangeEnd('start')
      }), _Typography$1 || (_Typography$1 = /*#__PURE__*/jsxs(Typography, {
        variant: "h5",
        children: ["\xA0", '–', "\xA0"]
...
function useCalendarState({
  ...
  const isDateDisabled = React.useCallback(day => validateDate$1(utils, day, {
    disablePast,
    disableFuture,
    minDate,
    maxDate,
...
var ArrowLeftIcon = createSvgIcon$1( /*#__PURE__*/jsx("path", {
  d: "M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.41z"
}), 'ArrowLeft');

var ArrowRightIcon = createSvgIcon$1( /*#__PURE__*/jsx("path", {
...
const PickersCalendarHeaderLabelItem = styled$1('div')({
  marginRight: 6
});
const PickersCalendarHeaderSwitchViewButton = styled$1(IconButton$1)({
  marginRight: 'auto'
});
const PickersCalendarHeaderSwitchView = styled$1(ArrowDropDownIcon)(({
  theme,
  ownerState
}) => _extends({
...
const DateRangePickerDayDay = styled$1(PickersDay$1, {
  name: 'MuiDateRangePickerDay',
  slot: 'Day'
})(({
  theme,
...
const DateRangePickerDay = /*#__PURE__*/React.forwardRef(function DateRangePickerDay(props, ref) {
  ...
  return /*#__PURE__*/jsx(DateRangePickerDayRoot, {
    className: clsx(classes.root, className),
    ownerState: ownerState,
    children: /*#__PURE__*/jsx(DateRangePickerDayRangeIntervalPreview, {
      role: "cell",
      className: classes.rangeIntervalPreview,
      ownerState: ownerState,
      children: /*#__PURE__*/jsx(DateRangePickerDayDay, _extends({}, other, {
        ref: ref,
        disableMargin: true,
...
var DateRangePickerDay$1 = /*#__PURE__*/React.memo(DateRangePickerDay, (prevProps, nextProps) => {
...
const PickersCalendarSlideTransition = styled$1(SlideTransition)({
  minHeight: weeksContainerHeight
});
...
function DateRangePickerViewMobile(props) {
  const {
    ...
    minDate: minDateProp,
    onChange,
    renderDay = (_, dayProps) => /*#__PURE__*/jsx(DateRangePickerDay$1, _extends({}, dayProps)),
    rightArrowButtonText
  } = props,
  ...
  return /*#__PURE__*/jsxs(React.Fragment, {
    children: [/*#__PURE__*/jsx(PickersCalendarHeader, _extends({
      components: components,
      componentsProps: componentsProps,
      leftArrowButtonText: leftArrowButtonText,
      maxDate: maxDate,
      ...
      rightArrowButtonText: rightArrowButtonText,
      views: onlyDayView
    }, other)), /*#__PURE__*/jsx(PickersCalendar, _extends({}, other, {
      date: date,
      onChange: onChange,
...
const ClockPickerArrowSwitcher = styled$1(PickersArrowSwitcher$1, {
  name: 'MuiClockPicker',
  slot: 'ArrowSwitcher',
...
const CalendarPickerRoot = styled$1(PickerView$1, {
...
const CalendarPickerViewTransitionContainer = styled$1(FadeTransitionGroup, {
  name: 'MuiCalendarPicker',
...
const DateRangePickerInput = /*#__PURE__*/React.forwardRef(function DateRangePickerInput(props, ref) {
  ...
  return /*#__PURE__*/jsx(DateRangePickerInputRoot, {
    onBlur: onBlur,
    ref: ref,
...
const DateRangePickerViewDesktopCalendar = styled$1(PickersCalendar)({
  minWidth: 312,
  minHeight: 288
});
const DateRangePickerViewDesktopArrowSwitcher = styled$1(PickersArrowSwitcher$1)({
...
function DateRangePickerViewDesktop(props) {
  const {
    ...
    minDate: minDateProp,
    onChange,
    renderDay = (_, dateRangeProps) => /*#__PURE__*/jsx(DateRangePickerDay$1, _extends({}, dateRangeProps)),
    rightArrowButtonText = 'Next month'
  } = props,
  ...
  return /*#__PURE__*/jsx(DateRangePickerViewDesktopRoot, {
    children: getCalendarsArray(calendars).map((_, index) => {
      const monthOnIteration = utils.setMonth(currentMonth, utils.getMonth(currentMonth) + index);
      return /*#__PURE__*/jsxs(DateRangePickerViewDesktopContainer, {
        children: [/*#__PURE__*/jsx(DateRangePickerViewDesktopArrowSwitcher, {
          onLeftClick: selectPreviousMonth,
          onRightClick: selectNextMonth,
        ...
        }), /*#__PURE__*/createElement(DateRangePickerViewDesktopCalendar, _extends({}, other, {
          key: index,
          date: date,
          onFocusedDayChange: doNothing,
...
function DateRangePickerView(props) {
  ...
  const renderView = () => {
    ...
    switch (wrapperVariant) {
      case 'desktop':
        {
          return /*#__PURE__*/jsx(DateRangePickerViewDesktop, _extends({
            calendars: calendars
          }, sharedCalendarProps));
        }
      ...
      default:
        {
          return /*#__PURE__*/jsx(DateRangePickerViewMobile, _extends({}, sharedCalendarProps));
        }
    }
  };
  ...
  return /*#__PURE__*/jsxs("div", {
    className: className,
    children: [toShowToolbar && /*#__PURE__*/jsx(DateRangePickerToolbar$1, {
      date: date,
      isMobileKeyboardViewOpen: isMobileKeyboardViewOpen,
      toggleMobileKeyboardView: toggleMobileKeyboardView,
      ...
      toolbarTitle: toolbarTitle,
      toolbarFormat: toolbarFormat
    }), isMobileKeyboardViewOpen ? /*#__PURE__*/jsx(MobileKeyboardInputView, {
      children: /*#__PURE__*/jsx(DateRangePickerInput$1, _extends({
        disableOpenPicker: true,
        ignoreInvalidInputs: true
      }, DateInputProps))
    }) : renderView()]
...
const DateRangePicker = /*#__PURE__*/React.forwardRef(function DateRangePicker(inProps, ref) {
  ...
  return /*#__PURE__*/jsx(ResponsiveTooltipWrapper, _extends({}, restProps, wrapperProps, {
    DateInputProps: DateInputProps,
    KeyboardDateInputComponent: KeyboardDateInputComponent,
    PureDateInputComponent: PureDateInputComponent,
    children: /*#__PURE__*/jsx(DateRangePickerView, _extends({
...
var BasicDateRangePicker = function () {
    ...
    return (React.createElement(LocalizationProvider, { dateAdapter: DateFnsUtils },
        React.createElement(DateRangePicker$1, { value: value, onChange: function (newValue) {
                setValue(newValue);
...
const DatePickerToolbarRoot = styled$1(PickersToolbar$1)({
  [`& .${classes.penIcon}`]: {
    position: 'relative',
    top: 4
  }
 ...
 */
const DesktopDatePicker$1 = /*#__PURE__*/React.forwardRef(function DesktopDatePicker(inProps, ref) {
...
const DatePicker = /*#__PURE__*/React.forwardRef(function DatePicker(inProps, ref) {
  ...
  const isDesktop = useMediaQuery(desktopModeMediaQuery);
  return isDesktop ? /*#__PURE__*/jsx(DesktopDatePicker$2, _extends({
    ref: ref,
    PopperProps: PopperProps,
    TransitionComponent: TransitionComponent,
    clearText: clearText,
    clearable: clearable
  }, other)) : /*#__PURE__*/jsx(MobileDatePicker$1, _extends({
    ref: ref,
    cancelText: cancelText,
    clearable: clearable,
    clearText: clearText,
...
var StyledPaper = styled(Paper$1)(templateObject_4$3 || (templateObject_4$3 = __makeTemplateObject([""], [""])));
...
var OutlineSearchRec17 = function (_a) {
    ...
    return (React__default.createElement(Search, null,
        React__default.createElement(SearchIconWrapper, null,
            React__default.createElement(default_1, { sx: { fontSize: "1.4rem" } })),
        ...
        React__default.createElement(CloseIconWrapper, null,
            React__default.createElement(default_1$1, { sx: { fontSize: "0.9rem" } }))));
};
